document.addEventListener('DOMContentLoaded', function() {
    ...
    const questions = [
        {
            question: "¿Quién era el dueño de la granja?", 
            answers: [
                "José Antonio", 
                "Jeremías", 
                "Antonio", 
            ...
            correctAnswer: "Jeremías"
        },
        {
            question: "¿Qué requería don Jeremías para su granja?", 
            answers: [
                "Un empleado para que la ayudara", 
                "Un vendedor de verduras y frutas", 
                "Un entrenador de caballos", 
                "Un vigilante nocturno"
            ], 
            correctAnswer: "Un empleado para que la ayudara"
        },
        {
            question: "¿Qué le pasó a don Jeremías después de un tiempo?", 
            answers: [
                "Se quedó en la ruina", 
                "Se quedó sin empleados en la granja", 
                "Fue el hombre más próspero de la región", 
                "Le dio empleo a todos los hombres del pueblo"
            ], 
            correctAnswer: "Se quedó en la ruina"
        },
        {
            question: "¿Qué hizo José Antonio por don Jeremías?", 
            answers: [
                "Le dio la oportunidad de trabajar y le brindó comida y techo en su granja", 
                "Lo despreció como don Jeremías lo hacía con él", 
                "Le vendió la granja nuevamente", 
                "Le devolvió la granja sin pedir nada a cambio"
            ], 
            correctAnswer: "Le dio la oportunidad de trabajar y le brindó comida y techo en su granja"
        },
        {
            question: "¿Qué enseñanza deja la lectura?", 
            answers: [
                "No hay que menospreciar a nadie, pues nunca se sabe cuándo necesitaremos de otros", 
                "La avaricia y el orgullo a la larga no sirven para nada", 
                "La riqueza no podrá comprar nunca una verdadera amistad", 
                "El mundo da muchas vueltas"
            ], 
            correctAnswer: "No hay que menospreciar a nadie, pues nunca se sabe cuándo necesitaremos de otros"
        }
    ];
